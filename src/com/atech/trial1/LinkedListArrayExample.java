...
{		
	...
	private int size = linkedlist.length, filled =0;
	...
	public static void main(String[] args) 
	{
		...
		LinkedListArrayExample object = new LinkedListArrayExample();
		while(choice!=9)
		{
	        ...
	        switch(choice)
	        {
	        	...
	        	case 3:
	        	{
	        		...
	        		object.addElementMiddle(number, position);
	        		break;
	        	}
	        	...
	        	case 7:
	        	{
                    ...
                    position = scan.nextInt();
	        		object.deleteParticularPosition(position);
	        		break;
	        	}
